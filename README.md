...
Download the function source code from the repository, or use the Mathematica Function Repository notebook to deploy the function on your machine and view documentation and examples (https://resources.wolframcloud.com/FunctionRepository/resources/MolecularComplexity).
